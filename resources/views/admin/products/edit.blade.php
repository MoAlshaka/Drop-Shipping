            ...
            <div class="card">
                <div class="p-12 px-6 py-6">
                    ...
                    <div class="grid lg:grid-cols-1 gap-12">
                        <div>
                            <form class="flex flex-col gap-12" action="{{ route('products.update', $product->id) }}"
                                ...
                                <div>
                                    ...
                                    <textarea class="form-input" id="example-textarea" rows="5" name="desc">{{ $product->name }}</textarea>
                                </div>
                                @error('desc')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tag" list="tags" value="{{ $product->tag }}">
                                    <datalist id="tags">
                                        @isset($tags)
                                            @foreach ($tags as $tag)
                                                @php
